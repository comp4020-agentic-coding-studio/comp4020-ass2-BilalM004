...
I also wanted to give different people their own personalities which could be seen. I gave Claude content from [JCU's Personality And Personal Attributes](https://www.jcu.edu.au/employability-edge/you-and-your-career/personality-and-personal-attributes), and then described each staff member for the session, and it used this to create their personality traits and tone, to appear in content '*authored by them*'.  ([`81af923`](https://github.com/comp4020-agentic-coding-studio/comp4020-ass2-BilalM004/commit/81af9234597700c0f53496123786dadd5562890b))
