---
title: Midsemester Checkpoint
description:
  Crossing 3 is the biggest bet of the first half — Set Up Shop, run by a
  team assigned for the Crossing — and the Hallway Showcase is where the
  team presents it, weighted for the scale of what got built together
week: 6
...
marking:
  mode: holistic
  description:
    Judged on the ambition and execution of what the team set up, as one
    stall rather than five individual slices of it — whether it's
    genuinely bigger in scope than an earlier solo Crossing rather than a
...
A short presentation at the Hallway Showcase, given by the team as one
account, covering what was set up, why it was scaled the way it was, and
what came of it — good and bad. No separate written submission; the
Showcase presentation is the checkpoint, marked on the stall as a whole
rather than on any one teammate's part in it. Missing the slot itself is
covered by [Policies](/policies/) — there's no presenting it late.
